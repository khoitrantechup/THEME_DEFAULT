                ...
                return n().createElement(
                    ...
                    n().createElement(
                        "a",
                        {
                            ...
                            rel: "noreferrer",
                            className:
                                "  flex items-center group rounded-2xl py-2 px-3 md:py-3 mb-4 md:px-4 last:mb-0 transition-all border-2  hover:bg-gradient-to-l from-[#C12DD1] to-[#6D8BF8] outline-none hover:scale-105 text-white ".concat(
                                    !c && "opacity-60",
                                    " shadow-md"
                                ),
                            onClick: function (t) {
                    ...
                    n().createElement(
                        ...
                        n().createElement(
                            ...
                            n().createElement(
                                ...
                                {
                                    className:
                                        "relative  grid min-h-full backdrop-blur-2xl bg-cover bg-gradient-to-r from-[#C12DD1] to-[#6D8BF8]"
                                },
                                n().createElement(
                                    "div",
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement(
                                                ...
                                                {
                                                    className:
                                                        "mt-2 text-[#EBE1C4]  font-semibold text-xs text-center  md:text-lg"
                                                },
                                                n().createElement(
                                                    "div",
